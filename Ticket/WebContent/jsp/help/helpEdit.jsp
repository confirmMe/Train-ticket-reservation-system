...
<html>
  ...
  <body>
  	<form action="<%=basePath%>servlet/helpDoEdit" method="post" onsubmit="return checkDate();">
    <table class="altrowstable" id="alternatecolor" width="99%;">
   		<tr>
    		...
    		<td>
    			...
    			<input type="text" id="key" name="key" value="${help.key }"/>
    		</td>
    		<th>
    			帮助信息
    		</th>
    		<td>
    			<input type="text" id="value" name="value" value="${help.value }"/>
    		</td>
