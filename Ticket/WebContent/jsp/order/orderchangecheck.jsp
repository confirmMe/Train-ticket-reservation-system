...
<div class="box">
	...
	<form action="<%=basePath%>servlet/OrderChangeUpdate" method="post" onsubmit="return check();">
	<table width="99%">
		...
		<tr>
			...
			<td><input type="hidden" id="phone" name="phone" value="${phone }"/></td>
			<td><input type="hidden" id="bodyid" name="bodyid" value="${bodyid }"/></td>
		...
		<tr>
			<td align="center" colspan="100"><input type="submit" value="确认改签"/></td>
		</tr>
	</table>
	</form>
...
<DIV>
	<BR><A href="http://www.12306.cn/mormhweb/gljd/gywm/">关于我们</A>  |  <A href="http://www.12306.cn/mormhweb/gljd/wzls/">网站声明</A>
	<BR>版权所有 © 2008-2015 中国铁路信息技术中心 中国铁道科学研究院 <BR><A href="http://www.miibeian.gov.cn/" target="_blank">京ICP备15003716号-3</A> 	  
</DIV>
