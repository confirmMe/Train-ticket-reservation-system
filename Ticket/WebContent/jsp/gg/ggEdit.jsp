...
<html>
  ...
  <body>
  	<form action="<%=basePath%>servlet/GgDoEdit" method="post" onsubmit="return checkDate();">
    <table class="altrowstable" id="alternatecolor" width="99%;">
   		<tr>
    		...
    		<td>
    			...
    			<input type="text" id="ggid" name="ggid" value="${user.ggid }"/>
    		</td>
    		<th>
    			公告标题
    		</th>
    		<td>
    			<input type="text" id="ggtitle" name="ggtitle" value="${user.ggtitle }"/>
    		</td>
    		<th>
    			公告内容
    		</th>
    		<td>
    			<input type="text" id="ggtext" name="ggtext" value="${user.ggtext }"/>
    		</td>
   		</tr>
   		<tr>
    		<th>
    		...
    		<td colspan="5">
    			<input type="text" id="ggtime" name="ggtime" value="${user.ggtime }" onclick="WdatePicker();"/>
    		</td>
   		</tr>
   		<tr>
