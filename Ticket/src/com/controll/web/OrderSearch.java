...
public class OrderSearch extends HttpServlet {
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		if(username!=null&&!"".equals(username)){
			...
			String sql = "select * from corder where username='"+username+"'";
			...
			request.getRequestDispatcher("/jspweb/websuc.jsp").forward(request, response);
		}else{
			request.setAttribute("message","您还没有登录，登录后才能查看您的订单信息！");
